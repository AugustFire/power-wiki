...
<table>
  <thead>
    <tr><th>颜色</th><th>色值</th><th>用途</th><th>状态</th></tr>
  </thead>
  <tbody>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr><td><span class="avatar" style="background:#36B37E">WW</span> 王五</td><td>设计 / 体验</td><td>Q2</td></tr>
...
<h2>进展同步</h2>
<ul>
  <li><strong style="color: #36B37E">Atlas 设计系统 v3.0 正式发布</strong>,反馈良好</li>
